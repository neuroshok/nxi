...
namespace ui
{
    user_session::user_session(ui::core& ui_core, nxi::user_session& nxi_user_session)
        : ui_core_{ ui_core }
    ...
    nxi::user_session& user_session::nxi_session() { return nxi_session_; }
    ...
    ui::main_interface* user_session::make_main_interface(ui::window* window) { return main_interface_(window); }
    void user_session::set_main_interface(std::function<ui::main_interface*(ui::window*)> fn) { main_interface_ = std::move(fn); }
