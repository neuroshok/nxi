...
namespace ui
{
    ...
    page_system::page_system(ui::core& ui_core) : ui_core_{ ui_core }
    {
        ...
        QObject::connect(&ui_core_.nxi_core().page_system(), qOverload<nxi::custom_page&, nxi::page_id>(&nxi::page_system::event_add), this, [this](nxi::custom_page& page, nxi::page_id)
        {
            qDebug() << "add custom ui page" << page.name();
            //auto ui_page = new ui::custom_page(ui_core_, page);
            //add(ui_page);
        });
    }
